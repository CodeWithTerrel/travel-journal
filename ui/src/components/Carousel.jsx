...
export default function Carousel({
    ...
    useEffect(() => {
        // autoplay loop - cycle through images
        const tick = () => {
    ...
    return (
        ...
        >
            {/* Slide track - hold all the image */}
            <div
            ...
            {/* Control buttons - made bigger with px-6 py-4 and text-3xl */}
            <button
                onClick={() => go(-1)}
                aria-label="Previous"
                className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/40 text-white px-6 py-4 rounded-md text-3xl hover:bg-black/60 transition"
            >
                ‹
            </button>
            <button
                onClick={() => go(1)}
                aria-label="Next"
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/40 text-white px-6 py-4 rounded-md text-3xl hover:bg-black/60 transition"
            >
                ›
            </button>
